...
namespace Prometheus.Tokens.Expressions
{
    ...
    public class SubExpression : OperatorExpression
    {
        ...
        /// Constructor
        /// </summary>
        public SubExpression(Context pContext, Cursor pCursor, BaseExpression pChild)
        ...
        /// Constructor
        /// </summary>
        public SubExpression(Context pContext, Cursor pCursor, BaseExpression pLeft, BaseExpression pRight)
