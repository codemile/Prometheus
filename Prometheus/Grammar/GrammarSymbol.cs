...
namespace Prometheus.Grammar
{
	...
	public enum GrammarSymbol
	{
		...
		@PostIncOperator = 139,                          // 0 <PostIncOperator>
		@PreDecOperator = 140,                           // 0 <PreDecOperator>
		@PreIncOperator = 141,                           // 0 <PreIncOperator>
		@PrintProc = 142,                                // 0 <PrintProc>
		@Procedure = 143,                                // 0 <Procedure>
		@Program = 144,                                  // 0 <Program>
		@ProgramCode = 145,                              // 0 <Program Code>
		@ProgramTest = 146,                              // 0 <Program Test>
		@QualifiedID = 147,                              // 0 <Qualified ID>
		@QualifiedList = 148,                            // 0 <Qualified List>
		@RejectProc = 149,                               // 0 <RejectProc>
		@RemainderExpression = 150,                      // 0 <RemainderExpression>
		@ReturnProc = 151,                               // 0 <ReturnProc>
		@ScopeProc = 152,                                // 0 <ScopeProc>
		@SearchChain = 153,                              // 0 <SearchChain>
		@Statement = 154,                                // 0 <Statement>
		@StatementorBlock = 155,                         // 0 <Statement or Block>
		@Statements = 156,                               // 0 <Statements>
		@SubExpression = 157,                            // 0 <SubExpression>
		@TestBlock = 158,                                // 0 <Test Block>
		@TestDecl = 159,                                 // 0 <Test Decl>
		@TestDecls = 160,                                // 0 <Test Decls>
		@TestExecute = 161,                              // 0 <Test Execute>
		@TestSuiteArray = 162,                           // 0 <TestSuite Array>
		@TestSuiteDecl = 163,                            // 0 <TestSuite Decl>
		@UnaryChain = 164,                               // 0 <UnaryChain>
		@UnsetProc = 165,                                // 0 <UnsetProc>
		@ValidID = 166,                                  // 0 <Valid ID>
		@Value = 167,                                    // 0 <Value>
		@VariableStatements = 168                        // 0 <Variable Statements>
	}
}
