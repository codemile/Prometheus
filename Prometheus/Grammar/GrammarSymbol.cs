...
namespace Prometheus.Grammar
{
	...
	public enum GrammarSymbol
	{
		...
		@QuantifierType = 170,                           // 0 <Quantifier Type>
		@RemainderExpression = 171,                      // 0 <Remainder Expression>
		@ReturnProc = 172,                               // 0 <Return Proc>
		@SearchChain = 173,                              // 0 <Search Chain>
		@Statement = 174,                                // 0 <Statement>
		@StatementorBlock = 175,                         // 0 <Statement or Block>
		@Statements = 176,                               // 0 <Statements>
		@SubExpression = 177,                            // 0 <Sub Expression>
		@TestBlock = 178,                                // 0 <Test Block>
		@TestDecl = 179,                                 // 0 <Test Decl>
		@TestDecls = 180,                                // 0 <Test Decls>
		@TestExecute = 181,                              // 0 <Test Execute>
		@TestSuiteArray = 182,                           // 0 <Test Suite Array>
		@TestSuiteDecl = 183,                            // 0 <Test Suite Decl>
		@TypeChain = 184,                                // 0 <Type Chain>
		@TypeOfFunc = 185,                               // 0 <TypeOf Func>
		@Types = 186,                                    // 0 <Types>
		@UnaryChain = 187,                               // 0 <Unary Chain>
		@UnsetProc = 188,                                // 0 <Unset Proc>
		@UntilControl = 189,                             // 0 <Until Control>
		@ValidID = 190,                                  // 0 <Valid ID>
		@Value = 191,                                    // 0 <Value>
		@VariableFunctions = 192,                        // 0 <Variable Functions>
		@VariableStatements = 193,                       // 0 <Variable Statements>
		@WhileControl = 194,                             // 0 <While Control>
		@WhileExpression = 195,                          // 0 <While Expression>
		@WithArray = 196                                 // 0 <With Array>
	}
}
