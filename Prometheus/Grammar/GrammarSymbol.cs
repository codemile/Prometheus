...
namespace Prometheus.Grammar
{
	...
	public enum GrammarSymbol
	{
		...
		@LoopUntilControl = 122,                         // 0 <Loop Until Control>
		@LoopWhileControl = 123,                         // 0 <Loop While Control>
		...
		@ValidID = 173,                                  // 0 <Valid ID>
		@Value = 174,                                    // 0 <Value>
		@VariableFunctions = 175,                        // 0 <Variable Functions>
		@VariableStatements = 176                        // 0 <Variable Statements>
	}
}
