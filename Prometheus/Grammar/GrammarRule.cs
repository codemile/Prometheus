namespace Prometheus.Grammar
{
    ...
    public enum GrammarRule
    {
        ...
        @ObjectDecl_Identifier_LParen_RParen2 = 85,
        // <Object Decl> ::= <Base Class> Identifier '(' <Formal Parameter List> ')' <Block> <End>
        @BaseClass_Type = 86, // <Base Class> ::= Type
        @BaseClass = 87, // <Base Class> ::= <Qualified ID>
        @FunctionDeclaration_function_Identifier_LParen_RParen = 88,
        // <Function Declaration> ::= function Identifier '(' <Formal Parameter List> ')' <Block>
        @FunctionDeclaration_function_Identifier_LParen_RParen2 = 89,
        ...
        @FunctionExpression_function_LParen_RParen2 = 91,
        ...
        @FormalParameterList_Comma_Identifier = 93,
